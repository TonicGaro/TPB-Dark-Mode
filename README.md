<h1 align="center">TPB-Dark-Mode</h1>
...
Then go <a href="chrome://extensions/">here</a> to manage your chrome extensions. Enable Developer mode and drag TPB.Dark.Mode.zip onto the window. If done correctly you should see the extension appear.<br><br>
